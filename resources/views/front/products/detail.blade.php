        ...
        <div class="row">
            <div id="gallery" class="span3">
                <a href="themes/images/products/large/f1.jpg" title="Blue Casual T-Shirt">
                    <img src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" style="width:100%" alt="Blue Casual T-Shirt"/>
                </a>
                <div id="differentview" class="moreOptopm carousel slide">
                    <div class="carousel-inner">
                        <div class="item active">
                            <a href="themes/images/products/large/f1.jpg"> <img style="width:29%" src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" alt=""/></a>
                            <a href="themes/images/products/large/f2.jpg"> <img style="width:29%" src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" alt=""/></a>
                            <a href="themes/images/products/large/f3.jpg" > <img style="width:29%" src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" alt=""/></a>
                        </div>
                        <div class="item">
                            <a href="themes/images/products/large/f3.jpg" > <img style="width:29%" src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" alt=""/></a>
                            <a href="themes/images/products/large/f1.jpg"> <img style="width:29%" src="{{asset('images/admin_images/product_images/large/6411212_preview-29800.png')}}" alt=""/></a>
