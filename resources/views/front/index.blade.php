...
@section('content')
    <div class="span9">
                                        ...
                                        <li class="span3">
                                            <div class="thumbnail">
                                                ...
                                                <a href="product_details.html">
                                                    <?php $product_image_path = 'images/admin_images/product_images/small/'.$item['main_image']; ?>
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <h4><a class="btn" href="product_details.html">VIEW</a> <span
                                                            class="pull-right">Rs.{{$item['product_price']}}</span></h4>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
        ...
        <ul class="thumbnails">
            <li class="span3">
                <div class="thumbnail">
                    <a href="product_details.html"><img src="{{asset('images/front_images/products/6.jpg')}}"
                                                        alt=""/></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="product_details.html"><img src="{{asset('images/front_images/products/7.jpg')}}"
                                                        alt=""/></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="product_details.html"><img src="{{asset('images/front_images/products/8.jpg')}}"
                                                        alt=""/></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="product_details.html"><img src="{{asset('images/front_images/products/9.jpg')}}"
                                                        alt=""/></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
